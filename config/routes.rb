Rails.application.routes.draw do
  ...
  # resources :song, only: [:index, :edit, :update, :new, :create, :show]
  # resources :artist, only: [:index, :edit, :update, :new, :create, :show]
  # resources :genre, only: [:index, :edit, :update, :new, :create, :show]
